...
public class UpdateOperation {
    public void updateOperation(String table, String database, String location, List<String> columnInQuery, List<String> valueInQuery, List<String> conditionFromQuery) throws Exception {
